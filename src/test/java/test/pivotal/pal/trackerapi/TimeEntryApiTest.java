...
public class TimeEntryApiTest {
    ...
    private TimeEntry timeEntry = new TimeEntry(123L, 456L, LocalDate.parse("2017-01-09"), 8);
    ...
    public void testCreate() throws Exception {
        ...
        assertThat(createJson.read("$.date", String.class)).isEqualTo("2017-01-09");
    ...
    public void testRead() throws Exception {
        ...
        assertThat(readJson.read("$.date", String.class)).isEqualTo("2017-01-09");
